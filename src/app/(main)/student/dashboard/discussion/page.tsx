    ...
    return (
        <div className="py-4 px-2">
            ...
            <div className="flex flex-col rounded-t-lg border border-gray-800 overflow-hidden md:w-4/5 w-full mx-auto">
                ...
                <div className="border-b group border-gray-800 p-4 hover:bg-gray-200 cursor-pointer">
                    <div className="flex items-center gap-2">
                ...
                <div className="border-b group border-gray-800 p-4 hover:bg-gray-200 transition-all cursor-pointer">
                    <div className="flex items-center gap-2">
                        <CircleDot color="green" size={20} />
                        <span className="text-black  font-semibold text-lg">
                            Question 1
