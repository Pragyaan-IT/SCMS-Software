...
const StudentTodayAttendance = () => {
    ...
    return (
        <div className="h-full w-full rounded-lg  bg-gray-800 text-white dark:bg-neutral-800 p-4" >
            <h1>Today&apos;s Attendance</h1>
            <div className="flex flex-col gap-2 p-4">
                {todayAttendance?.sort((a: any, b: any) => a.slot - b.slot).map((attendance, index) => (
                    <div key={index} className="flex justify-between px-4 py-2 bg-gray-400 rounded text-gray-800">
