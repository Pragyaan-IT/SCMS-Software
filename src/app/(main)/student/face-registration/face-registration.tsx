      ...
      <Card className="flex flex-col items-center justify-center">
        ...
        <CardContent className="grid gap-8 p-6 lg:grid-cols-2">
          <div className="flex flex-col items-center justify-center gap-4">
            ...
            <Button color="primary" onClick={captureImage} className="w-full">
              Capture Image
            </Button>
          </div>
          <div className="flex flex-col justify-between gap-4">
              ...
              <CardContent>
                {capturedImages.length === 0 && (
                  <p className="text-md dark:text-white">
                    No images captured yet. Click the &quot;Capture Image&quot;
            ...
            <div className="flex flex-col gap-4">
              ...
              <Button color="primary" type="submit" onClick={saveImages}>
                Save Images
              </Button>
            </div>
          </div>
